...
VALUES (45678, 20.99, 3, 'Action Park', 'Eugene Mulvihill', 92.75),
(56789, 10.59, 3, 'Fast Cars', 'Siri Appleton', 58.25),
(67890, 5.49, 3, 'Master Guitar 101', 'Shred Davis', 120.33);
...
(89012, 5.45, 'Horus Baker', 'Soothing Guitar', 12),
(90123, 15.98, 'Ice Cold', 'Best Beats vol III', 10);
...
VALUES (65432, 18.99, 1, 433, 'Summer of Love', 'Fantas Marjorie', 72.66),
(54321, 25.59, 2, 986, 'Wise Guys', 'Ben Nottingham', 55),
(43210, 16.99, 3, 'Lord of the Bracelets Trilogy', 'Octavian Eris', 245.66);
...
(21098, 15.98, 1, 'Billy Gilfoyle', 'Greatest Hits 77-92', 25 ),
(10987, 26.99, 'Blue Skies', 'A Different Breed', 7);
GO
